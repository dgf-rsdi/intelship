...
export const DfmRight = () => {
  ...
  const data = {
    ...
    datasets: [
      {
        label: "DFM Kanan",
        data: vesselDetail.map((vessel) => vessel.DFM2).slice(-10),
        fill: false,
    ...
    <Grid container spacing={2}>
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="DFM Mesin Kanan" />
          <Divider />
          <Typography variant="p" sx={{ px: 2, color: "orangered" }}>
            DFM Mesin Kanan Kapal, {tanggal?.split("T")[0]}
          </Typography>
                ...
                {vesselDetail.map(vessel => {
                  return (
                    <TableRow hover key={vessel.id}>
                      ...
                      <TableCell>{vessel.DFM2}</TableCell>
                      <TableCell></TableCell>
                    </TableRow>
                  );
                })}
      ...
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="Grafik Histori DFM Mesin Kanan" />
          <Divider />
          <CardContent>

    ...
    <Grid container spacing={2}>
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="RPM Mesin Kiri" />
          <Divider />
          <Typography variant="p" sx={{ px: 2, color: "orangered" }}>
            RPM Mesin Kiri Kapal, {tanggal?.split("T")[0]}
          </Typography>
                ...
                {vesselDetail.map(vessel => {
                  return (
                    <TableRow hover key={vessel.id}>
                      ...
                      <TableCell>
                        <SeverityPill color={statusMap[1]}>{vessel.RPM1}</SeverityPill>
                      </TableCell>
                    </TableRow>
                  );
                })}
      ...
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="Grafik Histori RPM Mesin Kiri" />
          <Divider />
          <CardContent>

    ...
    <Grid container spacing={2}>
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="RPM Mesin Kanan" />
          <Divider />
          <Typography variant="p" sx={{ px: 2, color: "orangered" }}>
            RPM Mesin Kanan Kapal, {tanggal?.split("T")[0]}
          </Typography>
                ...
                {vesselDetail.map(vessel => {
                  return (
                    <TableRow hover key={vessel.id}>
                      ...
                      <TableCell>
                      <SeverityPill color={statusMap[1]}>{vessel.RPM2}</SeverityPill>
                      </TableCell>
                    </TableRow>
                  );
                })}
      ...
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="Grafik Histori RPM Mesin Kanan" />
          <Divider />
          <CardContent>

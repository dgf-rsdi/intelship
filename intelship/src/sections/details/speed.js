...
export const Speed = () => {
  ...
  // var label = vesselDetail.map((vessel) => vessel.createdAt.split("T")[0])
  // labels.unshift(label);
    ...
    <Grid container spacing={2}>
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="History Kecepatan" />
          <Divider />
          <Typography variant="p" sx={{ px: 2, color: "orangered" }}>
            Kecepatan Kapal, {tanggal?.split("T")[0]}
          </Typography>
      ...
      <Stack sx={{ px: 2 }}>
        <Card sx={{ maxWidth: 450 }}>
          <CardHeader title="Grafik Histori Kecepatan" />
          <Divider />
          <CardContent>
